...
public class NavActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setTitleColor(R.color.isiko_yellow);
...
//        webView.loadUrl("https://www.youtube.com/embed/-xNN-bJQ4vI?rel=0&showinfo=0&autohide=1&hd=1");

        TextView mainTitle = (TextView) findViewById(R.id.main_title);
        mainTitle.setText(R.string.home);
